...
inline Value Object::getProperty(Runtime& runtime,
...
template <typename T>
void Object::setProperty(Runtime& runtime, const String& name,
                         T&& value) const {
...
template <typename T>
void Object::setProperty(Runtime& runtime, const PropNameID& name,
                         T&& value) const {
  setPropertyValue(runtime, name,
                   detail::toValue(runtime, std::forward<T>(value)));
}
...
inline void Object::setNativeState(Runtime& runtime,
                                   std::shared_ptr<NativeState> state) const {
  runtime.setNativeState(*this, state);
}

inline void Object::setExternalMemoryPressure(Runtime& runtime,
                                              size_t amt) const {
...
inline Value Function::call(Runtime& runtime,
...
inline Value Function::callWithThis(Runtime& runtime, const Object& jsThis,
...
template <typename... Args>
inline Value Function::callAsConstructor(Runtime& runtime,
                                         Args&&... args) const {
